// ignore_for_file: unrelated_type_equality_checks, avoid_print, sized_box_for_whitespace, non_constant_identifier_names
...
import '../../model/firebase_get.dart';
...
class _OutcomeCategoDetailState extends State<OutcomeCategoDetail> {
  String today = DateFormat("EEEEE, dd, MM, yyyy").format(
    DateTime.now(),
  );
  String yesterday = DateFormat("EEEEE, dd, MM, yyyy").format(
    DateTime.now().subtract(
      const Duration(days: 1),
    ),
  );
  String daybefore = DateFormat("EEEEE, dd, MM, yyyy").format(
    DateTime.now().subtract(
